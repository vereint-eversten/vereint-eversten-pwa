...
// Modul dynamisch laden (HTML in <main> einfügen)
async function loadModule(path) {
  ...
  try {
    ...
    // --- NEU: eingebettete Skripte ausführen ---
    ...
    // --- NEU: optionalen Modul-Init-Hook starten ---
    if (typeof window.__initModule === "function") {
      try {
        window.__initModule();
      } catch (e) {
        console.error("Fehler beim Modul-Init:", e);
      }
    }
...
// --------------------------------------------
// Hauptnavigation dynamisch aufbauen
// --------------------------------------------
(() => {
  const NAV = [
    {
